  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-3xl font-bold text-slate-100">CV Builder</h2>
      ...
      <NeumPanel className="p-8">
        {step === 1 && (
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-2">Professional Title</label>
              <NeumInput
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 neum-inset focus:outline-none focus:ring-2 focus:ring-[#7ec8e3]/50 text-slate-200 placeholder-gray-400 bg-transparent resize-y min-h-[120px] rounded-xl"
        ...
        {step > 1 && step < 6 && (
           <div className="text-center py-12">
             <h3 className="text-xl font-bold text-slate-100 mb-2">Step {step} Module</h3>
        ...
        {step === 6 && (
          <div className="text-center py-12 space-y-6">
            ...
            <h3 className="text-2xl font-bold text-slate-100">Ready to Publish</h3>
