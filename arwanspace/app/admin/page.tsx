  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <NeumPanel className="p-6 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-3xl font-bold text-slate-100">1,248</h3>
          </div>
        ...
        <NeumPanel className="p-6 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-3xl font-bold text-slate-100">342</h3>
          </div>
        ...
        <NeumPanel className="p-6 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-3xl font-bold text-slate-100">$4,500</h3>
          </div>
      ...
      <NeumPanel className="p-8 mt-8">
        <h3 className="text-xl font-bold text-slate-100 mb-6">Subscriptions Growth</h3>
